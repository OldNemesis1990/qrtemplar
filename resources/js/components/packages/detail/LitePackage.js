...
class LitePackage extends Component {
    constructor(props) {
        super(props);
    }
                ...
                <motion.table variants={tableAnim} initial="hidden" animate="enter" exit="exit" className="table tGrey">
                    <thead>
                        <tr className="tableHeading">
                            ...
                            <th>
                                <button className="btn btn-generate form-control" onClick={(e) => this.props.submitData(e, this.props.package, this.props.pricing)}>Sign Up it's {this.props.pricing == "0.00" ? "Free" : this.props.pricing}!</button>
                            </th>
                        </tr>
                        <tr>
                            <th colSpan="2"><h4>Great for tracking single campaigns!</h4></th>
                        </tr>
                        <tr>
                            <th>Description</th>
                            <th>Available</th>
